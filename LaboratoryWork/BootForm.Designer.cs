namespace LaboratoryWork
{
    partial class BootForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label6.Text = "Руководитель Волхонская Е.В.";
            ...
            this.label5.Text = "Разработал Рушко М.В.";
            ...
            this.label4.Text = "\"Исследование направленных и поляризационных свойств спиральной антенны\"";
            ...
            this.label3.Text = "Виртуальная лабораторная работа";
            ...
            this.label1.Text = "Балтийская государственная академия рыбопромыслового флота";
